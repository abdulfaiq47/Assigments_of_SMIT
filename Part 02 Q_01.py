...
"""
List = ["Tahir",44,"AI & Data science", "Yes"] # crete a list to store student data

for i in List: # using for loop to display each element inside the list
    print(i) # print the element 'i'